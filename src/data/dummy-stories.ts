...
export const dummyStories = [
  ...
  },
  {
    ...
    office: offices.find((o) => o.id === "munich")!,
    outcome: "not_received",
    description:
      "Applied at the München office but unfortunately didn't receive the Bildungsgutschein. The main challenge was proving that the course would significantly improve my job prospects. Despite having good qualifications, they suggested focusing on direct job applications instead.\n\nLearnings:\n- Be very specific about how the course relates to local job market demands\n- Gather supporting documents from potential employers if possible\n- Consider appealing the decision if you have strong grounds",
    date: "March 10, 2024",
  },
  {
    id: 3,
    ...
    office: offices.find((o) => o.id === "hamburg")!,
    outcome: "received",
    description:
      "Successfully received the Bildungsgutschein from the Hamburg office for a Web Development bootcamp. The process was straightforward but required thorough preparation.\n\nImportant aspects that helped:\n- Brought statistics showing high demand for web developers in Hamburg\n- Had letters of interest from potential employers\n- Demonstrated how my previous experience in design would complement the new skills\n\nThe case worker was particularly impressed by my research into the local job market.",
    date: "March 5, 2024",
  },
  {
    id: 4,
    ...
    office: offices.find((o) => o.id === "frankfurt")!,
    outcome: "received",
    description:
      "Got approved for Data Analytics training at the Frankfurt office. The process took 6 weeks but was worth the wait. My background in business administration helped make the case for transitioning to data analytics.\n\nKey success factors:\n- Prepared a detailed career transition plan\n- Showed examples of job postings requiring data analytics skills\n- Demonstrated basic programming knowledge through online courses\n\nAdvice: Start with some free online courses to show commitment to the field!",
    date: "March 1, 2024",
  },
  {
    id: 5,
    ...
    office: offices.find((o) => o.id === "cologne")!,
    outcome: "not_received",
    description:
      "Applied in Köln for UX/UI Design training. While the interview went well, my application was ultimately not approved. The main feedback was that my existing graphic design experience was considered sufficient for current market demands.\n\nWhat I learned:\n- The agency prioritizes complete career changes over skill upgrades\n- Having existing experience in a related field can work against you\n- Consider focusing on more specialized or technical aspects of UX\n\nPlanning to reapply with a focus on UX Research instead.",
